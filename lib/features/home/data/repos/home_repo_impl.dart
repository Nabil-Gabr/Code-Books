...
class HomeRepoImpl implements HomeRepo {
  ...
  @override
  Future<Either<Failure, List<BookModel>>> fatchFeaturedBooks() async {
    try {
  ...
  @override
  Future<Either<Failure, List<BookModel>>> fatchNewsetBooks() async {
    try {
      ...
      if (e is DioException) {
        left(ServerFailuer.fromDioExeption(e));
      }
  ...
  @override
  Future<Either<Failure, List<BookModel>>> fatchSimilarBooks({required String category}) async{
    try {
